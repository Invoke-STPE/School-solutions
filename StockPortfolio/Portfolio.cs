    ...
    public class Portfolio
    {
        ...
        public double TotalEarningsPercentage
        {
            get
            {
                ...
                double initialPrice = _stock1.InitialPrice + _stock2.InitialPrice + _stock3.InitialPrice;
        ...
        public void UpdateCurrentPrices(double percent1, double percent2, double percent3)
        {
            ...
            _stock1.CurrentPrice = percent1 * _stock1.CurrentPrice;
            _stock2.CurrentPrice = percent2 * _stock2.CurrentPrice;
            _stock3.CurrentPrice = percent3 * _stock3.CurrentPrice;
        }
